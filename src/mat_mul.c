/*
	https://gist.github.com/quswarabid/1df2269149970ce77f12727748390375
	Compile with this in CMD: gcc -I. convolution.c C:\Windows\System32\OpenCL.dll -o main.exe
	Note the time using PowerShell with this: Measure-Command {start-process mat_mul.exe -wait}
	To run on CPU, go to line 157, change CL_DEVICE_TYPE_*** to CL_DEVICE_TYPE_CPU, recompile and re-run
	To run on GPU, go to line 157, change CL_DEVICE_TYPE_*** to CL_DEVICE_TYPE_GPU, recompile and re-run
*/
...
int main(int argc, char const *argv[]) {
  ...
  if (clGetDeviceIDs(platform_id,/*CL_DEVICE_TYPE_ALL*//*CL_DEVICE_TYPE_CPU*/CL_DEVICE_TYPE_GPU,1,&device_id,&num_of_devices)) {
